...
NHANES %>%
  ...
  geom_vline(xintercept= mean(NHANES$Height, na.rm = TRUE), color = "red") +
  # Lager en linje for median høyde
  geom_vline(xintercept= median(NHANES$Height, na.rm = TRUE), color = "blue")
...
$$ \text{Standardavvik} = \sqrt{\text{Varians}} $$ $$ \sigma= \sqrt{ \frac{ \sum({x}_{i}-\overline{x})^2}{n-1}} = \sqrt{ \frac{1}{n-1}\sum({x}_{i}-\overline{x})^2 } $$
...
| Ordinalvnivå  | Stolpediagram, frekvenstabell            | Modus, median                 |
...
**Visualisering av data med en variabel** Tabellen viser hvordan vi presanterer forskjellige datatyper. Her er nominalnivå, ordinalnivå og internallnivå alt lagt til kvalitativenivå og forholdstalle er lagt til kvantitativnivå.

| Variabler                          | Figur                                              |
|------------------------------|------------------------------------------|
| Kvalitativenivå og kvalitativtnivå | Stolpediagram med forskjellige farger, krysstabell |
| Kvalitativenivå og kvantitativnivå | Boxplot                                            |
| Kvantitativnivå og kvantitativnivå | Scatter plot                                       |
